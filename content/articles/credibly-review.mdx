...
{"@context":"https://schema.org","@type":"Review","itemReviewed":{"@type":"FinancialProduct","name":"Credibly Merchant Cash Advance","description":"Merchant cash advances, working capital loans, and lines of credit from Credibly","url":"https://www.credibly.com/"},"author":{"@type":"Person","name":"Bar Alezrah","url":"https://themcaguide.com/about/bar-alezrah"},"publisher":{"@type":"Organization","name":"The MCA Guide","url":"https://themcaguide.com"},"datePublished":"2026-04-03","reviewRating":{"@type":"Rating","ratingValue":"3.7","bestRating":"5","worstRating":"1"},"reviewBody":"Percentage-of-sales holdback model helps businesses with variable revenue. Over $2 billion funded since founding. Factor rates can climb to 1.45 and some borrowers report aggressive renewal tactics."}
`}</script>

<div className="my-6 flex items-center gap-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
  <div className="text-3xl font-bold text-blue-900">3.7<span className="text-base text-blue-600">/5</span></div>
