...
For more on how reconciliation fits into the broader legal framework, see [MCA laws in New York](/articles/mca-laws-new-york) and the sibling article on [MCA loan attorneys](/articles/mca-attorney), which covers recharacterization at a deeper level.
