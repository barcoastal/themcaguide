...
<script type="application/ld+json">{`
{
  ...
  "itemReviewed": {
    ...
    "description": "Merchant cash advance for Shopify store owners with advances from $200 to $2M",
  ...
  "reviewBody": "Shopify Capital offers MCA-style funding with factor rates (1.10 to 1.25) that are lower than most traditional MCAs. Underwriting is automated against Shopify sales data. Fit: active Shopify merchants."
}
`}</script>
