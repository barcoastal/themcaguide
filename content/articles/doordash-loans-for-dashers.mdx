...
**Step 3: Negotiate.** Even cash advance apps will sometimes accept a lump-sum settlement for less than the full balance if collections has escalated. MCA-style products are more negotiable than most borrowers realize because the lender knows the factor rate is challenging and would rather get 60 cents on the dollar than sue. Our [how to negotiate MCA settlement](/articles/can-you-negotiate-mca-debt) playbook adapts to gig-MCA products directly.
