---
title: "MCA Factor Rates Explained: Convert 1.35 to APR (Free Calculator)"
description: "A 1.35 factor rate is not 35% APR. It often works out to 70% or more. Learn how factor rates work, how to convert them to APR, and what an MCA really costs."
publishedAt: "2026-03-25"
updatedAt: "2026-04-14"
author: "Bar Alezrah"
heroImage: "/images/articles/factor-rates.webp"
pillar: "what-is-mca"
category: "mca-basics"
...
<li><strong>Factor rate is not interest rate.</strong> A factor rate of 1.35 is NOT 35% APR. On a 6-month MCA, 1.35 typically equals 70-90% APR.</li>
<li><strong>Quick formula:</strong> Advance amount × factor rate = total repayment. Example: $50,000 × 1.35 = $67,500 total.</li>
<li><strong>APR conversion shortcut:</strong> (Factor rate - 1) × (12 / repayment months) × 2 = approximate APR. So 1.35 over 6 months ≈ 140% raw, roughly 70% APR in practice.</li>
<li><strong>Typical factor rate range:</strong> 1.10 to 1.50. Lower factor rates require stronger credit, revenue, and time-in-business profiles.</li>
<li><strong>Factor rate does NOT reduce with early payoff</strong> on most MCAs, unlike interest-based loans. Some providers offer prepayment discounts.</li>
<li><strong>Free APR converter:</strong> <a href="/tools/factor-rate-to-apr-calculator" className="underline">factor rate to APR calculator</a> does the math for you.</li>
</ul>
</div>
...
- [Factor Rate to APR Converter](/tools/factor-rate-to-apr) — instantly convert any factor rate to APR
- [MCA Cost Calculator](/tools/mca-calculator) — see total cost, daily payment, and effective APR
- [MCA Payment Schedule](/tools/mca-payment-schedule) — generate a full daily payment calendar
