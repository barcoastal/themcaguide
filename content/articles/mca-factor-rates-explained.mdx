...
<ComparisonTable
  headers={["Feature", "Factor Rate", "Interest Rate"]}
  rows={[
...
<FAQ items={[
  {
    question: "Can I negotiate my MCA factor rate?",
    answer: "Yes, in many cases you can negotiate. If you have strong revenue, good credit, or competing offers from other providers, use that as leverage. Some providers will lower your factor rate to win your business, especially if you have a solid repayment history with previous advances."
  },
  {
    question: "Do I save money if I repay my MCA early?",
    answer: "Usually not. Unlike traditional loans where early repayment reduces interest charges, most MCAs require you to pay the full predetermined amount regardless of how quickly you repay. Some providers offer a small discount for early payoff, but this is not standard. Always ask about early payoff terms before signing."
  },
  {
    question: "How do I convert a factor rate to an APR?",
    answer: "To estimate the APR, first calculate the total fee (funding amount multiplied by the factor rate, minus the funding amount). Then divide the fee by the funding amount to get the percentage cost. Finally, annualize it by dividing 365 by the number of days in the repayment term and multiplying by the percentage cost. For example, a 1.30 factor rate repaid over 180 days is roughly equivalent to a 60% APR."
  },
  {
    question: "Is a factor rate of 1.40 too high?",
    answer: "A factor rate of 1.40 means you are paying 40 cents for every dollar advanced, which is a significant cost. Whether it is 'too high' depends on your specific situation. If the funds will generate substantially more revenue than the $0.40 per dollar cost, it may still be worthwhile. However, if you can qualify for a lower rate or alternative funding, a 1.40 factor rate is generally considered expensive."
  }
]} />
