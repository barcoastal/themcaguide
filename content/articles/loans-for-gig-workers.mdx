...
If you have already signed one of these, the remedies are the same as for a business MCA: negotiate, settle, or in severe cases file Chapter 7 bankruptcy. See the [MCA debt relief options](/articles/mca-debt-relief) guide.
