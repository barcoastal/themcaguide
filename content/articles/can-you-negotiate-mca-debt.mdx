...
author: "Bar Alezrah"
heroImage: "/images/articles/negotiate.webp"
...
For a detailed negotiation walkthrough — including counter-offer scripts and what to do when a funder refuses — see our [how to negotiate an MCA settlement guide](/articles/how-to-negotiate-mca-settlement). If you reach an agreement, our [MCA settlement letter template](/articles/mca-settlement-letter-template) provides a ready-to-use framework that covers all the language needed to make the settlement binding.
...
- [MCA Affordability Calculator](/tools/mca-affordability-calculator) — show lenders your cash flow situation
- [Debt-to-Revenue Calculator](/tools/debt-to-revenue-calculator) — know your financial health before negotiating
- [MCA Stacking Calculator](/tools/mca-stacking-calculator) — calculate your total MCA burden
