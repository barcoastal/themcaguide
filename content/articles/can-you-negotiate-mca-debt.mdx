...
For a detailed negotiation walkthrough — including counter-offer scripts and what to do when a funder refuses — see our [how to negotiate an MCA settlement guide](/articles/can-you-negotiate-mca-debt). If you reach an agreement, our [MCA settlement letter template](/articles/mca-settlement-letter-template) provides a ready-to-use framework that covers all the language needed to make the settlement binding.
