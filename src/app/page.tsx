      ...
      <header className="masthead">
        <div className="wrap">
          <div className="masthead-bar">
            <span>Vol. I · {todayLine()}</span>
            <span><span className="dot">●</span> Independent · Not a Lender · Not a Broker</span>
            <span>By Bar Alezrah · New York Edition</span>
          </div>
          <div className="masthead-title">The MCA Guide</div>
          <div className="masthead-sub">All the funding facts that are fit to print</div>
          <nav className="mast-nav">
            <Link href="/" className="active">Front Page</Link>
            <Link href="/tools/mca-calculator">The Calculator</Link>
            <Link href="/guides/mca-debt-relief-2026-guide">The Real Cost</Link>
            <Link href="/blog/before-mca">Alternatives</Link>
            <Link href="/glossary">Glossary &amp; FAQ</Link>
          </nav>
        </div>
      </header>
        ...
        <div className="wrap">
          <div className="footer-grid">
            <div>
              ...
              <p style={{ maxWidth: "420px", color: "var(--ink-soft)", fontSize: "14.5px", marginTop: "8px" }}>
